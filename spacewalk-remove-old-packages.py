...
##import xmlrpclib #python2 import
from xmlrpc import client # python3 import
import datetime
##import ConfigParser
import configparser 
import sys
...
def main():
    ...
    if options.cfg_file:
        ...
        while str(options.spw_user) == 'None' or '': options.spw_user = input("Spacewalk Username: ")
    ...
    spacewalk = client.ServerProxy("https://%s/rpc/api" % options.spw_server, verbose=0, allow_none=True)
